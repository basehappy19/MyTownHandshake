...
const reportRoutesForAdmin = async (fastify) => {
    ...
    fastify.put("/admin/report/:id/status", async (req, reply) => {
        const { id } = req.params;
        ...
        return reply.send({ ok: true, ...result }).code(200);
    });
};
exports.default = reportRoutesForAdmin;
